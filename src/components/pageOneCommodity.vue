<template>
	<div class="one-commodity">
		...
		<div class="cart-btn">
	        ...
	        <my-input-number :count=" counter " v-show=" counter>0 " @change="getOperator"></my-input-number>
        </div>
...
<script>
	export default{
		name:"one-commodity",
		props:['imgUrl','title','content','price','count','itemId'],
		data(){
			return {
				loadingImage:true,
				oneCommodity:{
